...
class PaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $medical_records = MedicalRecord::filterMultiple($type_date,$start_date,$end_date,$state_pay,$state,$specie,$search_pets,$search_vets,$type_service)
    ...
    public function downloadExcel(Request $request){
        ...
        return Excel::download(new DownloadMedicalRecord($medical_records),"listado_de_pagos_reporte.xlsx");
    }
