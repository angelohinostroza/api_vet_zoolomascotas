...
class VeterinarieController extends Controller
{
            ...
            $schedule_hours_groups->push([
                ...
                "segments_time" => $schedule_hour->map(function($schedule_h) {
                    return [
                        ...
                        "hour_start_format" => Carbon::parse(date("Y-m-d").' '.$schedule_h->hour_start)->format("h:i A"),//8:00 AM o 13:00 PM
    ...
    public function store(Request $request)
    {
        ...
        if($is_user_exists){
            return response()->json([
                "message" => 403,
                "message_text" => "El acceso ya exixte"
            ]);
        }
        ...
        return response()->json([
            "message" => 200,
            "message_text" => "El usuario se ha creado correctamente"
        ]);
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        return response()->json([
            "message" => 200,
            "message_text" => "El veterinario se ha editado correctamente"
        ]);
    }
    ...
    public function destroy(string $id)
    {
        ...
        return response()->json([
            "message" => 200,
            "message_text" => "El veterinario se ha eliminado correctamente"
        ]);
    }
}
